...
void StateInitLoad::loadAllGameTextures() {
    ...
    Checkpoint::loadAssets("assets/objects/floor/checkpointTransparent.jpg", sf::IntRect(0, 0, 16, 16),
        sf::IntRect(0, 0, 64, 8), sf::IntRect(0, 0, 8, 64),
        sf::IntRect(0, 0, 96, 8), sf::IntRect(0, 0, 8, 96),
        sf::IntRect(0, 0, 128, 8), sf::IntRect(0, 0, 8, 128));
