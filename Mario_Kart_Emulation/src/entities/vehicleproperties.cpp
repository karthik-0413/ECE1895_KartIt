...
const VehicleProperties  // not even fair
    VehicleProperties::GODMODE(0.3f, 0.4f, 0.3f, 10.0f, false);

float VehicleProperties::PLAYER_CHARACTER_MULTIPLIER = 2.0f;
VehicleProperties VehicleProperties::PLAYER = GODMODE;
