...
class Driver : public WallObject {
   ...
   public:
    ...
    int getLap() const { return laps; }
    int getState() const { return state; }

    bool isWithinCheckpointRange(const sf::Vector2f &pos);
    ...
    // Mutator for playerSelection
    void setPlayerSelection(bool value) { playerSelection = value; }

    // Accessor for playerSelection
    bool getPlayerSelection() const { return playerSelection; }
