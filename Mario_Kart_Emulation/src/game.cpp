...
// Global pointer to the current Game instance.
Game* gameInstance = nullptr;

// Global accessor function for the Game instance.
Game* getGameInstance() {
    return gameInstance;
}

// Global Gas Checkpoint Flag
bool gasCheckpoint = false;

// Global Accessor function for the Gas Checkpoint Flag
bool getGasCheckpoint() { return gasCheckpoint; }

// Global Mutator function for the Gas Checkpoint Flag
void setGasCheckpoint(bool value) { gasCheckpoint = value; }
...
Game::Game(const int _bx, const int _by, const int _framerate)
    ...
    // Set the global game instance pointer.
    gameInstance = this;
